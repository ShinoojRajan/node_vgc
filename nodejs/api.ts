...
function createResponse(res: http.ServerResponse,statusCode:number,data:string,contentType:string='text/plain'){
...
const server = http.createServer((req: http.IncomingMessage, res: http.ServerResponse) => {
    ...
    //res.end('Hello!! This is a Node.js application using TypeScript.');
        ...
        const userName=parseURL.query.userName as string;
